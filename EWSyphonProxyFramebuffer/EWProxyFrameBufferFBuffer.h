...
class info_ennowelbers_syphon_proxyframebuffer_driver;
...
class info_ennowelbers_syphon_proxyframebuffer_fbuffer : public IOFramebuffer
{
OSDeclareDefaultStructors(info_ennowelbers_syphon_proxyframebuffer_fbuffer)
private:
