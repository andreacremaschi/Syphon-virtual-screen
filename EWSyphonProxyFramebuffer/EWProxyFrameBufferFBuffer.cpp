...
OSDefineMetaClassAndStructors(info_ennowelbers_syphon_proxyframebuffer_fbuffer, IOFramebuffer)
...
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::Connect(int mode)
{
	if(connected)
...
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::Disconnect()
{
	if(connected)
	{
		connected=false;
...
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::State()
{
	if(!connected)
		return 0;
	else
...
void info_ennowelbers_syphon_proxyframebuffer_fbuffer::SwitchResolution()
{
	if(warmup)
	{
...
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::getAttribute( IOSelect attribute, uintptr_t * value )
{
	union myvar
	{
		IOSelect attribute;
...
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::setAttribute( IOSelect attribute, uintptr_t value )
{
...
//TODO
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::setAttributeForConnection(IOIndex connection, IOSelect attribute, uintptr_t value)
{
...
//
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::getAttributeForConnection(IOIndex connectIndex, IOSelect attribute, uintptr_t *value)
{
	union myvar
	{
		IOSelect attribute;
...
bool info_ennowelbers_syphon_proxyframebuffer_fbuffer::init(OSDictionary *dict)
{
...
void info_ennowelbers_syphon_proxyframebuffer_fbuffer::free(void)
{
	IOLog("EWProxyFrameBuffer: Free\n");
	super::free();
}

bool info_ennowelbers_syphon_proxyframebuffer_fbuffer::start(IOService *provider)
{
...
void info_ennowelbers_syphon_proxyframebuffer_fbuffer::stop(IOService *provider)
{
	super::stop(provider);
	if(graphicMem!=NULL)
	{
...
IODeviceMemory * info_ennowelbers_syphon_proxyframebuffer_fbuffer::getApertureRange(IOPixelAperture aperture)
{
...
IODeviceMemory * info_ennowelbers_syphon_proxyframebuffer_fbuffer::getVRAMRange()
{
...
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::enableController()
{
...
IOItemCount info_ennowelbers_syphon_proxyframebuffer_fbuffer::getConnectionCount()
{
...
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::getCurrentDisplayMode(IODisplayModeID * displayMode, IOIndex * depth)
{
...
IOItemCount info_ennowelbers_syphon_proxyframebuffer_fbuffer::getDisplayModeCount()
{
...
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::getDisplayModes(IODisplayModeID * allDisplayModes)
{
...
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::getInformationForDisplayMode(IODisplayModeID displayMode, IODisplayModeInformation *info)
{
...
const char * info_ennowelbers_syphon_proxyframebuffer_fbuffer::getPixelFormats()
{
...
UInt64 info_ennowelbers_syphon_proxyframebuffer_fbuffer::getPixelFormatsForDisplayMode(IODisplayModeID displayMode, IOIndex depth)
{
...
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::getPixelInformation(IODisplayModeID displayMode, IOIndex depth, IOPixelAperture aperture, IOPixelInformation * pixelInfo)
{
...
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::setDisplayMode(IODisplayModeID displayMode, IOIndex depth)
{
...
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::setCursorImage(void *img)
{
...
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::setCursorState(SInt32 x, SInt32 y, bool visible)
{
	cursorX=x;
	cursorY=y;
...
IOReturn info_ennowelbers_syphon_proxyframebuffer_fbuffer::getStartupDisplayMode(IODisplayModeID * displayMode, IOIndex * depth)
{
/*    displayMode = 0;
    depth = 00;*/
	return kIOReturnUnsupported;
