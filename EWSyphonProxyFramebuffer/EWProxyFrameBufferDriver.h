...
class info_ennowelbers_syphon_proxyframebuffer_fbuffer;
class info_ennowelbers_syphon_proxyframebuffer_client;
 ...
 * to the framebuffer
 */
class info_ennowelbers_syphon_proxyframebuffer_driver: public IOService
{
	OSDeclareDefaultStructors(info_ennowelbers_syphon_proxyframebuffer_driver)
private:
	void initFB();
	bool shouldInitFB();
public:
	IOBufferMemoryDescriptor *buffer;
	info_ennowelbers_syphon_proxyframebuffer_fbuffer *fbuffer;
	info_ennowelbers_syphon_proxyframebuffer_client *eventClient;
