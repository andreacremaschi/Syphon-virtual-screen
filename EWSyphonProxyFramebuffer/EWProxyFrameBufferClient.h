 ...
 */
class info_ennowelbers_syphon_proxyframebuffer_client: public IOUserClient
{
	OSDeclareDefaultStructors(info_ennowelbers_syphon_proxyframebuffer_client)
protected:
	info_ennowelbers_syphon_proxyframebuffer_driver *fProvider;
	task_t fTask;
...
protected:
	...
	static IOReturn sStartFramebuffer(info_ennowelbers_syphon_proxyframebuffer_client* target, void* reference, IOExternalMethodArguments *arguments);
	
	virtual IOReturn StartFramebuffer(int mode);
	
	static IOReturn sStopFramebuffer(info_ennowelbers_syphon_proxyframebuffer_client* target, void*reference, IOExternalMethodArguments *arguments);
	
	virtual IOReturn StopFramebuffer(void);
	
	static IOReturn sCheckFramebufferState(info_ennowelbers_syphon_proxyframebuffer_client* target, void *reference, IOExternalMethodArguments *arguments);
	
	virtual IOReturn CheckFramebufferState(void);
		
	static IOReturn sUpdateMemory(info_ennowelbers_syphon_proxyframebuffer_client* target, void *reference, IOExternalMethodArguments *arguments);
	
	virtual IOReturn UpdateMemory(void);
	
	static IOReturn sGetModeCount(info_ennowelbers_syphon_proxyframebuffer_client* target, void *reference, IOExternalMethodArguments *arguments);
	
	virtual IOReturn GetModeCount(void);
	
	static IOReturn sGetModeInfo(info_ennowelbers_syphon_proxyframebuffer_client* target, void *reference, IOExternalMethodArguments *arguments);
	
	virtual IOReturn GetModeInfo(int mode, EWProxyFramebufferModeInfo *info);
	
	static IOReturn sGetCursorState(info_ennowelbers_syphon_proxyframebuffer_client* target, void *reference, IOExternalMethodArguments *arguments);
	
	virtual IOReturn GetCursorState(int *x, int *y, bool *visible);
	
	static IOReturn sGetCursorResolution(info_ennowelbers_syphon_proxyframebuffer_client* target, void *reference, IOExternalMethodArguments *arguments);
	
	virtual IOReturn GetCursorResolution(int *width, int *height);
	
	static IOReturn sEnableCursorEvents(info_ennowelbers_syphon_proxyframebuffer_client* target, void *reference, IOExternalMethodArguments *arguments);
#ifdef __LP64__
	...
	static IOReturn sDisableCursorEvents(info_ennowelbers_syphon_proxyframebuffer_client* target, void *reference, IOExternalMethodArguments *arguments);
